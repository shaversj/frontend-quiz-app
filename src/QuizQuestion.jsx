...
const QuizQuestion = () => {
  const buttons = [
    ...
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M0 6C0 2.68629 2.68629 0 6 0H34C37.3137 0 40 2.68629 40 6V34C40 37.3137 37.3137 40 34 40H6C2.68629 40 0 37.3137 0 34V6Z" fill="#F4F6FA" />
      <path
        d="M16.0079 26C15.8879 26 15.7859 25.958 15.7019 25.874C15.6179 25.79 15.5759 25.688 15.5759 25.568V13.85C15.5759 13.718 15.6179 13.61 15.7019 13.526C15.7859 13.442 15.8879 13.4 16.0079 13.4H20.3999C21.6119 13.4 22.6079 13.586 23.3879 13.958C24.1799 14.33 24.7739 14.882 25.1699 15.614C25.5779 16.346 25.7879 17.24 25.7999 18.296C25.8239 18.824 25.8359 19.292 25.8359 19.7C25.8359 20.108 25.8239 20.57 25.7999 21.086C25.7759 22.202 25.5719 23.126 25.1879 23.858C24.8039 24.578 24.2219 25.118 23.4419 25.478C22.6739 25.826 21.6899 26 20.4899 26H16.0079ZM18.0779 23.93H20.3999C21.0719 23.93 21.6179 23.834 22.0379 23.642C22.4579 23.45 22.7639 23.144 22.9559 22.724C23.1599 22.292 23.2679 21.728 23.2799 21.032C23.2919 20.672 23.2979 20.36 23.2979 20.096C23.3099 19.82 23.3099 19.55 23.2979 19.286C23.2979 19.01 23.2919 18.698 23.2799 18.35C23.2559 17.366 23.0099 16.64 22.5419 16.172C22.0739 15.704 21.3299 15.47 20.3099 15.47H18.0779V23.93Z"
        fill="#626C7F"
      />
    </svg>,
  ];
